...
interface PokeballInterface extends ethers.utils.Interface {
  functions: {
    "addAdmin(address)": FunctionFragment;
    "amountMinted(uint256)": FunctionFragment;
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address[],uint256[])": FunctionFragment;
    "burn(address,uint8,uint256)": FunctionFragment;
    "caps(uint256)": FunctionFragment;
    ...
    "setCaps(uint256[],uint256[])": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "caps", values: [BigNumberish]): string;
  encodeFunctionData(
...
export class Pokeball extends BaseContract {
  ...
  functions: {
    ...
    caps(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
